...
["I'm tired of all the r\or\ser\se about beauty being only skin-deep. That's deep enough. What do you want - an adorable pancreas?", "Jean Kerr"],
...
function generateQuote () {
	var quotearray = quotes[Math.floor(Math.random()*163)];
	quote = quotearray[0];
	quotee = quotearray[1];
	return 0;
}
...
function displayQuote() {
   ...
   $('#quotee').removeClass('animated fadein');
	...
	document.getElementById("quotee").innerHTML = quotee;
	document.getElementById("twitter").href='http://twitter.com/home/?status="' + quote + '" - ' + quotee;
